...
@media(max-width:760px){.marketTop,.marketTemplateHead,.marketHistoryHead{align-items:stretch;grid-template-columns:1fr}.marketTopActions{display:grid;grid-template-columns:1fr}.marketTopActions form{grid-template-columns:1fr 1fr}.marketTopActions>*{width:100%}.marketTabs{overflow-x:auto;flex-wrap:nowrap;padding-bottom:4px}.marketTabs a{white-space:nowrap}.marketForms{grid-template-columns:minmax(0,1fr) 88px}.marketForms label:first-child{grid-column:1/-1}.marketForms button{grid-column:1/-1;width:100%}.marketTable{min-width:0;table-layout:auto}.marketTable thead{display:none}.marketTable,.marketTable tbody,.marketTable tr,.marketTable td{display:block;width:100%}.marketTable tr{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:14px;border-bottom:1px solid var(--line)}.marketTable td{border:0;padding:0;min-width:0}.marketTable td:first-child,.marketTable td:nth-child(2),.marketTable td:nth-child(6),.marketTable td:last-child{grid-column:1/-1}.marketTable td:before{content:attr(data-label);display:block;font-size:10px;color:var(--mut);font-weight:800;margin-bottom:4px}.marketPriceUnit{grid-template-columns:minmax(0,1fr) 62px}.marketCalculated{min-height:38px}.marketTable td:last-child form{justify-content:flex-end}.marketDelete{width:44px}.marketResultValues{grid-template-columns:1fr}.marketHistoryActions{grid-template-columns:1fr 1fr}.marketPrintMenu,.marketPrintActions{grid-template-columns:1fr}.marketPrintMenu>*,.marketPrintActions>*{width:100%}}
</style>`;}
